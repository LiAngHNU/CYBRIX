...
subplot(2,3,5), ...
   semilogx(ff,PPh_avz,'-'),axis([0.01 10 -200 0]), xlabel('frequency, Hz','fontsize',12),ylabel('phase, deg','fontsize',12)
grid

subplot(2,3,3), ...
    semilogx(ff,GG_ay,'-'),axis([0.01 10 0 0.006]), ylabel('gain, g/deg','fontsize',12),grid,
title('Bode plot: Steer to Ay')
subplot(2,3,6), ...
   semilogx(ff,PPh_ay,'-'),axis([0.01 10 -80 20]), xlabel('frequency, Hz','fontsize',12),ylabel('phase, deg','fontsize',12)
grid
